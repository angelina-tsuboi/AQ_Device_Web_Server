...
#define WIFI_SSID "SpectrumSetup-63"
#define WIFI_PASSWORD "wittysnake418"

// Insert Firebase project API Key
#define API_KEY "AIzaSyAGUga7svVQimmUh7DFxj5PhsHqK_w0AI0"
...
<head>
  ...
  <style>
    ...
    p {  font-size: 1.2rem;}
    body {  margin: 0;}
    .topnav { overflow: hidden; background-color: #007bf7; color: white; font-size: 1.7rem; }
